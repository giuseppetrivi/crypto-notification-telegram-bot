...
2. You have to upload into your server's database the file `config/crypto_notification_db.sql`.. There is also the `README.md` file about the config info and the database tables.
